        ...
        while True:
            ...
            if not len(self.enemies):
                ...
                if self.transition > 30:
                    self.level = min(self.transition + 1, len(os.listdir('data/maps')) - 1)
                    self.load_level(self.level)
            ...
            screenshake_offset = (random.random() * self.screenshake - self.screenshake / 2, random.random() * self.screenshake - self.screenshake )
